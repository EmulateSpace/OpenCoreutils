...
objdump-objs	:= $(patsubst %,%/built-in.o, $(objs-y))
objdump-libs	:= $(patsubst %,%/lib.a, $(libs-y))
objdump-all	:= $(objdump-objs) $(objdump-libs)
...
clean-dirs      := $(addprefix _clean_, $(objdump-dirs))
...
help:
	...
	@echo  '* objdump	  	  - Build the application'
